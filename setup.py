...
setup(
    name='UrbanDictPython',  # How you named your package folder (MyLib)
    packages=['UrbanDictPython'],  # Chose the same as "name"
    ...
    download_url='https://github.com/blacksmithop/UrbanDict/archive/v_0_1.tar.gz',  # I explain this later on
